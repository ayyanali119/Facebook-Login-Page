...
export default function Home() {
  return (
    <div className="bg-gray-100 h-screen flex items-center justify-center">
         {/* left side */}   
      <div className="text-3xl w-1/2 px-10 text-black">  
        <Image src={"/pictures/Facebook.svg"} width={300} height={100}
         alt="Facebook logo "/>   
      ...
      <div className="bg-white flex flex-col p-5 rounded-xl w-1/3">
         ...
         <input className="my-2 border border-1 border-gray-100 p-3 rounded-md focus:outline-1 outline-blue-600" type="password" placeholder="password"/>
          <button className="bg-blue-600 my-2 py-2 text-lg font-bold text-white
          ...
          <button className=" bg-green-500 my-2 py-2 px-2 text-lg font-bold text-white
